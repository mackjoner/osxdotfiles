...
# c.InlineBackend.rc = {'savefig.dpi': 72, 'figure.edgecolor': (1, 1, 1, 0), 'figure.subplot.bottom': 0.125, 'font.size': 10, 'figure.facecolor': (1, 1, 1, 0), 'figure.figsize': (6.0, 4.0)}
...
# 
# c.MappingKernelManager.root_dir = '/home/liuerfire'
...
# 
c.FileNotebookManager.notebook_dir = NOTEBOOK_DIR
